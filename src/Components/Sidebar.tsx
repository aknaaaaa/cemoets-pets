...
function Sidebar() {
  ...
  return (
    <nav
      className={`shadow-md h-screen p-2 bg-sky-600 flex flex-col justify-between duration-500 ${
        open ? "w-60" : "w-16"
      }`}
    >
      <div>
      ...
      <div className="flex items-center gap-2 px-3 py-2">
        ...
        >
          ...
          <span className="text-xs text-gray-200">budikarambol@gmail.com</span>
        </div>
      </div>
    </nav>
  );
